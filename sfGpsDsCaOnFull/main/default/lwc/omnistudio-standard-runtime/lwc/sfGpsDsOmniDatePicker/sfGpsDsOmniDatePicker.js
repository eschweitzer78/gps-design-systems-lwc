import { api } from "lwc";
import OmnistudioDatePicker from "c/sfGpsDsOsrtDatePicker";
import SfGpsDsOmniInputMixin from "c/sfGpsDsOmniInputMixin";

const DEBUG = false;
const CLASS_NAME = "SfGpsDsOmniDatePicker";

export default class extends SfGpsDsOmniInputMixin(OmnistudioDatePicker) {
  assignDate(value) {
   ...
   * It does not match with the UTCPpattern as it doesn't have time info...
