...
function resolveUnitGranularity(key) {
  return (
    Object.prototype.hasOwnProperty.call(formatGranularity, key[0]) ||
    Number(formatGranularity[key[0]]) ||
    0
  );
}
...
export { determineMaxGranularity, resolveUnitGranularity, unitName };
