import { api } from "lwc";
import OmnistudioDatetimePicker from "c/sfGpsDsOsrtDatetimePicker";
import SfGpsDsOmniInputMixin from "c/sfGpsDsOmniInputMixin";

const DEBUG = false;
const CLASS_NAME = "SfGpsDsOmniDatetimePicker";
...
export default class extends SfGpsDsOmniInputMixin(OmnistudioDatetimePicker) {
  _sfGpsDsTimeElement;
