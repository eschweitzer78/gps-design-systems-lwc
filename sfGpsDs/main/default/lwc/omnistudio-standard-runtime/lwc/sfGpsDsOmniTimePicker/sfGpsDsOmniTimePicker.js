import { api } from "lwc";
import OmnistudioTimePicker from "c/sfGpsDsOsrtTimePicker";
import SfGpsDsOmniInputMixin from "c/sfGpsDsOmniInputMixin";

const DEBUG = false;
const CLASS_NAME = "SfGpsDsOmniTimePicker";

export default class extends SfGpsDsOmniInputMixin(OmnistudioTimePicker) {
  /* methods */
