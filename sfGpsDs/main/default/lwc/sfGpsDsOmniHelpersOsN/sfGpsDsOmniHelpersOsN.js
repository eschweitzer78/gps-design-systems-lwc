...
import OmniscriptInternalUtils from 'omnistudio/omniscriptInternalUtils';

export function omniGetMergedField(omniElement, label) {
  return label && omniElement._jsonData && omniElement.scriptHeaderDef && omniElement.jsonDef
