...
export default class sfGpsDsAuNswSFormAddressTypeaheadOsN extends SfGpsDsFormTypeaheadOsN {
  @api street;
  @api suburb;
    ...
    switch (event.target.name) {
      ...
      case "country":
        if (this.country !== event.target.value) {
          ...
          // eslint-disable-next-line @lwc/lwc/no-api-reassignments
          this.state = this.isDomestic ? DEFAULT_STATE : "";
        }
  ...
  get computedSuburbLabel() {
    return this.isDomestic ? "Suburb" : "City/town";
  }

  get computedPostcodeLabel() {
    return this.isDomestic ? "Postcode" : "Postal/zip code";
  }
}
