...
import { getContextBefore, Pos, getLine } from "c/sfGpsDsCodeMirrorLine";
import {
  replaceRange,
  Range,
  replaceOneSelection
} from "c/sfGpsDsCodeMirrorModel";
import { countColumn, Pass, spaceStr } from "c/sfGpsDsCodeMirrorUtil";
...
export function indentLine(cm, n, how, aggressive) {
  ...
  if (!aggressive && !/\S/.test(line.text)) {
    ...
    if (indentation === Pass || indentation > 150) {
      if (!aggressive) return false; // ESC
      how = "prev";
    }
  }
  if (how === "prev") {
