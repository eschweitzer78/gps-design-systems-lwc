...
export function getOppositeAxis(
  axis: Axis
): Axis {
  return axis === "x" ? "y" : "x";
}

export function getAxisLength(
  axis: Axis
): Length {
  return axis === "y" ? "height" : "width";
}

export function getSideAxis(
  placement: Placement
): Axis {
  return ["top", "bottom"].includes(getSide(placement)) ? "y" : "x";
}

export function getAlignmentAxis(
  placement: Placement
): Axis {
...
export function getExpandedPlacements(
  placement: Placement
...
export function getOppositePlacement<T extends string>(
  placement: T
): T {
  return placement.replace(
...
export function getPaddingObject(
  padding: Padding
): SideObject {
...
export function rectToClientRect(
  rect: Rect
): ClientRectObject {
