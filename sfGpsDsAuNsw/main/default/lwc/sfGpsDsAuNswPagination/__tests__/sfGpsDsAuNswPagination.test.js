...
describe('c-sf-gps-ds-au-nsw-pagination', () => {
  ...
  it('shows next and previous buttons and single page number when single page', () => {
    ...
    let prevButton = element.shadowRoot.querySelector(".nsw-pagination ul li:first-child .nsw-icon-button");
    expect(prevButton).not.toBeNull();

    let nextButton = element.shadowRoot.querySelector(".nsw-pagination ul li:last-child .nsw-icon-button");
  ...
  it('shows five page numbers and no ellipsis with 5 pages and 3 is active', () => {
    ...
    expect(active.textContent).toBe(`${element.srOnlyPre}${element.activePage}`);
  });
