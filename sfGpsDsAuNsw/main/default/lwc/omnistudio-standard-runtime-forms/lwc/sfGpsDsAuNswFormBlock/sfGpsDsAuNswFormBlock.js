...
import tmpl from "./sfGpsDsAuNswFormBlock.html";

export default class extends SfGpsDsAuNswStatusHelperMixin(SfGpsDsFormBlock) {
  /* computed */
  ...
  toggleContent() {
    /* There is actually not a lot of clever or required stuff that the original method does:
      ...
      - handles expandContent and ariaHiddenValue (and that's really the only bit we require here) + showValidation
