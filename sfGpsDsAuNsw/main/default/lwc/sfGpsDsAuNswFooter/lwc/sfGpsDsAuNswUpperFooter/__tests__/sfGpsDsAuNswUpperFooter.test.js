...
import SfGpsDsAuNswUpperFooter from "c/sfGpsDsAuNswUpperFooter";

const ELT_TAG = "c-sf-gps-ds-au-nsw-upper-footer";
const SIMPLE_NAV = [
  {
    text: "A",
    subNav: [
...
describe("c-sf-gps-ds-au-nsw-upper-footer", () => {
  afterEach(() => {
  ...
  it("renders as expected", () => {
    ...
    // Assert
    const headings = element.querySelectorAll(".nsw-footer__heading");
    const headingAs = element.querySelectorAll(".nsw-footer__heading > a");
