...
export default class SfGpsDsCaOnFormFile extends SfGpsDsFormFile {
   ...
   * 
   * This runs after each render to ensure the computed value
   * reflects the current DOM state (hint text may be dynamic).
   * 
   * @override
   */
  renderedCallback() {
    ...
    // Build aria-describedby from helper elements
